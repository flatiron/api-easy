...
exports.describe = function (text) {
  return {
    ...
    _request: function (/* method [uri, data, params] */) {
      ...
      //
      // Set the `method` property of the request option `outgoing`
      // using the information provided to `_request()`.
      //
      ...
      context[this.current] = {
        topic: function () {
          ...
          //
          // Build the URI during execution to allow dynamic use of `suite.use`
          //
